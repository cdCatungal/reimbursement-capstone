...
describe('Approval Flow Utils', () => {
  ...
  describe('getNextApprover', () => {
    ...
    it('should handle SUL approval flow correctly', () => {
      ...
      expect(getNextApprover('SUL', 'Sales Director')).toBe('Invoice Specialist');
      expect(getNextApprover('SUL', 'Invoice Specialist')).toBe('Finance Officer');
  ...
  describe('findApproverBySapCode', () => {
    ...
    it('should find Account Manager with matching SAP code (sap_code_2)', () => {
      const approver = findApproverBySapCode('Account Manager', 'E-11111-2222', mockUsers);
    ...
    it('should return any user with role for non-SAP dependent roles', () => {
      const approver = findApproverBySapCode('Sales Director', 'E-12345-6789', mockUsers);
    ...
    it('should return null when no user with that role exists', () => {
      const approver = findApproverBySapCode('Unknown Role', 'E-12345-6789', mockUsers);
...
// reimbursement-backend/tests/utils/emailTemplates.test.js
describe('Email Templates', () => {
  describe('approvalProgressTemplate', () => {
    it('should generate valid HTML email', () => {
      const { approvalProgressTemplate } = require('../../src/utils/emailTemplates.js');
    ...
    it('should format currency correctly', () => {
      ...
      const html = approvalProgressTemplate(reimbursement, 'Approver', 'SUL', 'Manager', 1);
  ...
  describe('finalApprovalTemplate', () => {
    it('should generate final approval email', () => {
      const { finalApprovalTemplate } = require('../../src/utils/emailTemplates.js');
      ...
      const html = finalApprovalTemplate(reimbursement, 'Finance Officer', 'Finance Officer');
  ...
  describe('rejectionTemplate', () => {
    it('should generate rejection email with remarks', () => {
      const { rejectionTemplate } = require('../../src/utils/emailTemplates.js');
  ...
  describe('newSubmissionToApproverTemplate', () => {
    it('should generate new submission notification', () => {
      const { newSubmissionToApproverTemplate } = require('../../src/utils/emailTemplates.js');
  ...
  describe('nextApproverNotificationTemplate', () => {
    it('should generate next approver notification', () => {
      const { nextApproverNotificationTemplate } = require('../../src/utils/emailTemplates.js');
...
// reimbursement-backend/tests/utils/sendEmail.test.js
